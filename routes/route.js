...
deleteOneroute, fetchAllRoutesByDateRange, fetchRouteById, bulkupdateEta,
updateStopsWithCollectionpoint, driverLocationLiveTracking, finishRoute, fetchinProgressRoutes  } = require("../controllers/route");
//below changes made now it shoudl update


router.post("/route/fetchroutebetweenDates", fetchAllRoutesByDateRange);
router.post("/route/driverlocationlivetracking", driverLocationLiveTracking);
router.post("/route/datamigration1", updateStopsWithCollectionpoint);
router.post("/route/ownerfetchinprogressroutes", fetchinProgressRoutes);
...
router.put('/route/bulkupdateEta', bulkupdateEta);
router.patch('/route/updategeolocation', updateGeolocation);
router.patch('/route/finishroute', finishRoute);
